# Generated by Django 5.2.6 on 2025-09-17 18:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('consultas', '0003_remove_episodio_tblepisodio_id_epis_d2b241_idx_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='TempEpisodioAdmision',
            fields=[
                ('id_ingreso', models.IntegerField(db_column='IdIngreso', primary_key=True, serialize=False)),
